            ...
            <div class="card-body">
                <form action="{{route('book.store')}}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="isbn" name="isbn" class="form-control @error('isbn') is-invalid @enderror" value="{{old('isbn')}}" autocomplete="isbn">
                            @error('isbn')
                                <span class="invalid-feedback" role="alert">
                                    {{$message}}
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select name="authors[]" multiple id="authors" class="form-control">
                                <option disabled selected>{{__('اختر مؤلف')}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select name="publisher" id="publisher" class="form-control">
                                <option disabled selected>{{__('اختر ناشر')}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="publish_year" name="publish_year" type="number" class="form-control @error('publish_year') is-invalid @enderror" value="{{old('publish_year')}}" autocomplete="publish_year">
                            @error('publish_year')
                                <span class="invalid-feedback" role="alert">
                                    {{$message}}
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="number_of_pages" name="number_of_pages" type="number" class="form-control @error('number_of_pages') is-invalid @enderror" value="{{old('number_of_pages')}}" autocomplete="number_of_pages">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number"id="number_of_capies" name="number_of_capies" class="form-control @error('number_of_capies') is-invalid @enderror" value="{{old('number_of_capies')}}" autocomplete="number_of_capies">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="price" name="price" type="number" class="form-control @error('price') is-invalid @enderror" value="{{old('price')}}" autocomplete="price">
                            @error('price')
                                <span class="invalid-feedback" role="alert">
                                    {{$message}}
                                </span>
